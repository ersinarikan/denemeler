	...
	public static void main(String[] args) {
		...
		do {
			...
			case 3:
				...
				break;
			default:
				faturaSms = (float) (kullanimSms * 1.5);
			}
			// Internet hesaplama
			...
			case 3:
				...
				break;
			default:
				faturaInternet = (float) (kullanimInternet * 0.15);
			}
			// Konuşma Hesaplama
			...
			case 3:
				...
				break;
			default:
				faturaKonusma = (float) (kullanimKonusma * 0.15);
			}
			System.out.println("Özel Tüketim Vergisini Giriniz ");

			otv = giris.nextInt();
			fatura = ((faturaKonusma + faturaInternet + faturaSms)
					+ (((faturaKonusma + faturaInternet + faturaSms) * otv) / 100));
